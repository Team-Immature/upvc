...
const AboutContact = () => {
  return (
    <div className='min-h-screen mx-auto '>
      <NavBar />
      {/* Banner section with content on top */}
      <div className='relative w-full aspect-[16/9] max-h-[700px] overflow-hidden bg-[#b2b8b2]'>
        <img
          src={ban}
        ...
        <div className='absolute   hidden lg:block top-25 z-5 right-15 xl:mr-20   items-center justify-center xl:mt-10 '>
